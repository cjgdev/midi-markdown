...
"""
PyInstaller spec file for MIDI Markup Language compiler.
...
Build with: pyinstaller midimarkup.spec
"""
...
datas += [(os.path.join(src_dir, 'midi_markdown', 'parser', 'mml.lark'),
...
#     bundle_identifier='com.midimarkdown.midimarkup',
#     version=__version__,
#     info_plist={
#         'CFBundleName': 'MIDI Markup Language Compiler',
#         'CFBundleDisplayName': 'midimarkup',
